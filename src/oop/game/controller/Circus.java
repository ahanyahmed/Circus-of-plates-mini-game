...
import oop.game.model.Constants;
import eg.edu.alexu.csd.oop.game.GameObject;
import eg.edu.alexu.csd.oop.game.World;
import oop.game.model.ClownObject;
import java.util.LinkedList;
import java.util.List;
import oop.game.view.AudioPlayer;
import oop.game.model.Shapes;
...
public class Circus implements World{
    ...
    private void createGameObject() {
        ...
        if (!musicPlaying){
            AudioPlayer audio = AudioPlayer.getInstance("src\\resources\\song.wav");
            audio.play();
            musicPlaying = true;
        }
    ...
    public boolean refresh() {
        ...
        if (timeout && !soundPlayed){
            AudioPlayer audio = AudioPlayer.getInstance("src\\resources\\GameOver.wav");
            audio.play();
            plateEngine.setShouldStop(true);
            obstacleEngine.setShouldStop(true);
            soundPlayed = true;
